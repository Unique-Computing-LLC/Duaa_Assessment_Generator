...
class Question(Base):
    ...
    question_id = Column(String(36), unique=True, nullable=True)
    problem_bank_id = Column(String(36), nullable=True)
...
class QuestionGenerator:
    ...
    def save_question_to_db(self, question_data: Dict[str, Any]) -> str:
        """
        ...
        Returns:
            The question_id of the inserted question
        """
        try:
            ...
            logger.info(f"Question saved to database with question_id: {question_uuid}")
